...
public class TestController {
    ...
    @PutMapping(value = "/test-todo/todo/{id}")
    ...
    @DeleteMapping(value = "/test-todo/todo/{id}")
    public void delete(@PathVariable("id") Long id){
        userTodoService.delete(id);
    }

    @DeleteMapping(value = "/test-todo/todo/all")
    public void deleteAll(){
        userTodoService.deleteAll();
    }

    @GetMapping(value = "/test-todo/user/{userId}")
